...
return {
  ...
  highlights = function(scheme, config)
    ...
    return {
      ...
      KapeCyan   = { fg = scheme.base.cyan },
      KapeBlue   = { fg = scheme.base.blue },
      KapeViolet = { fg = scheme.base.magenta },
      ...
      KapeCyanSign   = { fg = scheme.base.cyan,    bg = scheme.base.dimmed5 },
      KapeBlueSign   = { fg = scheme.base.blue,    bg = scheme.base.dimmed5 },
      KapeVioletSign = { fg = scheme.base.magenta, bg = scheme.base.dimmed5 },
