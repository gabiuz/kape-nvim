-- lua/kape/theme/triggers/module.lua
...
---@param module_name string The module name (e.g., "bufferline")
---@param plugin_name string The plugin name (e.g., "akinsho/bufferline.nvim")
