...
---@field hex_to_rgb fun(hex: string): Kape.RGB
---@field rgb_to_hex fun(rgb: Kape.RGB): string
---@field apply_highlights fun(highlights: table<string, vim.api.keyset.highlight>)

local blend = require("kape.colors.blend")
local convert = require("kape.colors.convert")
