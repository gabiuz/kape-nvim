...
local M = function(p, opts)
	...
	local legacy = {
		...
		TSComment           = "Comment",
		TSConditional       = "KapeViolet",        -- keyword
		...
		TSFuncBuiltin       = "KapeOrange",        -- function
		TSFuncMacro         = "KapeOrange",        -- function
		TSFunction          = "KapeOrange",        -- function
		TSFunctionCall      = "KapeOrange",        -- function
		TSInclude           = "KapeViolet",        -- import
		TSKeyword           = "KapeViolet",        -- keyword
		TSKeywordFunction   = "KapeViolet",        -- keyword
		TSKeywordOperator   = "KapeFg",            -- punctuation-like
		TSKeywordReturn     = "KapeViolet",        -- keyword
		TSLabel             = "KapeOrange",
		TSLiteral           = "String",
		...
		TSStrike            = "KapeGrey",
		TSString            = "KapeOrange",        -- string
		TSStringEscape      = "KapeOrange",        -- string escape
		TSStringRegex       = "KapeOrange",        -- string
